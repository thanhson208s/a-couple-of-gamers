...
export interface GamePlugin {
  ...
  applyAction(state: GameState, action: GameAction, playerIndex: 1 | 2): GameStep[];
  ...
  // Return indices of players eligible for playing next
  getNextTurns(state: GameState): (1 | 2)[];

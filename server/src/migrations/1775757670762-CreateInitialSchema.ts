...
export class CreateInitialSchema1775757670762 implements MigrationInterface {
    name = 'CreateInitialSchema1775757670762'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "games" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "slug" text NOT NULL, "name" text NOT NULL, "enabled" boolean NOT NULL DEFAULT false, "bundle_url" text, "bundle_version" text, CONSTRAINT "UQ_095bbaa4f028fa5a03e37f631d6" UNIQUE ("slug"), CONSTRAINT "PK_c9b16b62917b5595af982d66337" PRIMARY KEY ("id"))`);

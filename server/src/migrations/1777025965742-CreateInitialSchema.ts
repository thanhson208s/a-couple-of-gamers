...
export class CreateInitialSchema1777025965742 implements MigrationInterface {
    name = 'CreateInitialSchema1777025965742'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" character(10) NOT NULL, "provider" text NOT NULL, "provider_id" text NOT NULL, "display_name" text NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_6425135effde2ab8322f8464932" UNIQUE ("provider_id"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "matches" ADD CONSTRAINT "fk_matches_player1" FOREIGN KEY ("player1_id") REFERENCES "users"("id") ON DELETE CASCADE`);
        await queryRunner.query(`ALTER TABLE "matches" ADD CONSTRAINT "fk_matches_player2" FOREIGN KEY ("player2_id") REFERENCES "users"("id") ON DELETE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "moves" ADD CONSTRAINT "fk_moves_player" FOREIGN KEY ("player_id") REFERENCES "users"("id") ON DELETE SET NULL`);
        await queryRunner.query(`ALTER TABLE "refresh_tokens" ADD CONSTRAINT "FK_3ddc983c5f7bcf132fd8732c3f4" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "refresh_tokens" DROP CONSTRAINT "FK_3ddc983c5f7bcf132fd8732c3f4"`);
        await queryRunner.query(`ALTER TABLE "moves" DROP CONSTRAINT "fk_moves_player"`);

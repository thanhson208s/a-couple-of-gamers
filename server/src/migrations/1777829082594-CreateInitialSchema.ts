...
export class CreateInitialSchema1777829082594 implements MigrationInterface {
    name = 'CreateInitialSchema1777829082594'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user_devices" ("token" text NOT NULL, "user_id" character(10) NOT NULL, "platform" text NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_241f440058ea34377edd80db924" PRIMARY KEY ("token"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user_friends" ("requester_id" character(10) NOT NULL, "addressee_id" character(10) NOT NULL, "status" text NOT NULL DEFAULT 'pending', "created_at" TIMESTAMPTZ NOT NULL DEFAULT now(), "updated_at" TIMESTAMPTZ NOT NULL DEFAULT now(), CONSTRAINT "CHK_user_friends_no_self" CHECK ("requester_id" != "addressee_id"), CONSTRAINT "PK_user_friends" PRIMARY KEY ("requester_id", "addressee_id"))`);
        await queryRunner.query(`ALTER TABLE "user_friends" ADD CONSTRAINT "FK_user_friends_requester" FOREIGN KEY ("requester_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_friends" ADD CONSTRAINT "FK_user_friends_addressee" FOREIGN KEY ("addressee_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "matches" ADD CONSTRAINT "FK_matches_player1" FOREIGN KEY ("player1_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "matches" ADD CONSTRAINT "FK_matches_player2" FOREIGN KEY ("player2_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "refresh_tokens" ADD CONSTRAINT "FK_3ddc983c5f7bcf132fd8732c3f4" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "refresh_tokens" DROP CONSTRAINT "FK_3ddc983c5f7bcf132fd8732c3f4"`);
        await queryRunner.query(`ALTER TABLE "matches" DROP CONSTRAINT "FK_matches_player2"`);
        await queryRunner.query(`ALTER TABLE "matches" DROP CONSTRAINT "FK_matches_player1"`);
        ...
        await queryRunner.query(`ALTER TABLE "user_friends" DROP CONSTRAINT "FK_user_friends_addressee"`);
        await queryRunner.query(`ALTER TABLE "user_friends" DROP CONSTRAINT "FK_user_friends_requester"`);
